...
$(function(){
    ...
    // 24b
    function open24b(){
        document.querySelector('.q24b').style.display='block';	
    }
    function close24b(){
        document.querySelector('.q24b').style.display='none';
    }
...
// else if (q01val == '6' && !isFiveMultiply(q01_6.val())){
//     e.stopImmediatePropagation();
//     alert('最多增加0.5');
// }
...
$(".2btn").click(function (e) {
    ...
    // else if (q02val == '6' && !isFiveMultiply(q02_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
...
$(".3btn").click(function (e) {
    ...
    // else if (q03val == '6' && !isFiveMultiply(q03_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
...
$(".4btn").click(function (e) {
    ...
    // else if (q04val == '6' && !isFiveMultiply(q04_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
...
$(".5btn").click(function (e) {
    ...
    // else if (q05val == '6' && !isFiveMultiply(q05_6.val())){
    //         e.stopImmediatePropagation();
    //         alert('最多增加0.5');
    //     }
});
...
$(".6btn").click(function (e) {
    ...
    // else if (q06val == '6' && !isFiveMultiply(q06_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
});
...
$(".7btn").click(function (e) {
    ...
    // else if (q07val == '6' && !isFiveMultiply(q07_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
});
...
$(".8btn").click(function (e) {
    ...
    // else if (q08val == '6' && !isFiveMultiply(q08_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
});
...
$(".9btn").click(function (e) {
    ...
    // else if (q09val == '6' && !isFiveMultiply(q09_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
});
...
$(".10btn").click(function (e) {
    ...
    // else if (q10val == '6' && !isFiveMultiply(q10_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
});
...
$(".11btn").click(function (e) {
    ...
    // else if (q11val == '6' && !isFiveMultiply(q11_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
...
$(".12btn").click(function (e) {
    ...
    // else if (q12val == '6' && !isFiveMultiply(q12_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
...
$(".13btn").click(function (e) {
    ...
    // else if (q13val == '6' && !isFiveMultiply(q13_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
});
...
$(".14btn").click(function (e) {
    ...
    // else if (q14val == '6' && !isFiveMultiply(q14_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
});
...
$(".15btn").click(function (e) {
    ...
    // else if (q15val == '6' && !isFiveMultiply(q15_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
...
$(".16btn").click(function (e) {
    ...
    // else if (q16val == '6' && !isFiveMultiply(q16_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
});
...
$(".17btn").click(function (e) {
    ...
    // else if (q17val == '6' && !isFiveMultiply(q17_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
});
...
$(".18btn").click(function (e) {
    ...
    // 判斷小數位數
    // qava118_6.val(fix(qava118_6.val(),1));
    ...
    else if (qaval == '6' && qava118_6.val() == 0){
        e.stopImmediatePropagation();
        alert('數值不能為0');
    }
    else if (qaval == '6' && qava118_6.val() < 0){
    ...
    // else if (qaval == '6' && !isFiveMultiply(qava118_6.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
...
$(".19btn").click(function (e) {
    ...
    // 判斷小數位數
    // q19_1.val(fix(q19_1.val(),1));
    // q19_2.val(fix(q19_2.val(),1));
    // q19_3.val(fix(q19_3.val(),1));
    ...
    // else if (q19val == '1' && !isFiveMultiply(q19_1.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q19val == '2' && !isFiveMultiply(q19_2.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q19val == '3' && !isFiveMultiply(q19_3.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
...
$(".20btn").click(function (e) {
    ...
    // 判斷小數位數
    // q20_1.val(fix(q20_1.val(),1));
    // q20_2.val(fix(q20_2.val(),1));
    // q20_3.val(fix(q20_3.val(),1));
    ...
    // else if (q20val == '1' && !isFiveMultiply(q20_1.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q20val == '2' && !isFiveMultiply(q20_2.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q20val == '3' && !isFiveMultiply(q20_3.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
...
$(".21btn").click(function (e) {
    ...
    // 判斷小數位數
    // q21_1.val(fix(q21_1.val(),1));
    // q21_2.val(fix(q21_2.val(),1));
    // q21_3.val(fix(q21_3.val(),1));
    ...
    // else if (q21val == '1' && !isFiveMultiply(q21_1.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q21val == '2' && !isFiveMultiply(q21_2.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q21val == '3' && !isFiveMultiply(q21_3.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
...
$(".22btn").click(function (e) {
    ...
    // 判斷小數位數
    // q22_1.val(fix(q22_1.val(),1));
    // q22_2.val(fix(q22_2.val(),1));
    // q22_3.val(fix(q22_3.val(),1));
    ...
    // else if (q22val == '1' && !isFiveMultiply(q22_1.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q22val == '2' && !isFiveMultiply(q22_2.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q22val == '3' && !isFiveMultiply(q22_3.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    if (!q22a)
         e.stopImmediatePropagation();
    var q22b = _this.find("input[name=q22b]:checked").val();
    if (!q22b)
         e.stopImmediatePropagation();
...
$(".23btn").click(function (e) {
    ...
    // 判斷小數位數
    // q23_1.val(fix(q23_1.val(),1));
    // q23_2.val(fix(q23_2.val(),1));
    // q23_3.val(fix(q23_3.val(),1));
    ...
    // else if (q23val == '1' && !isFiveMultiply(q23_1.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q23val == '2' && !isFiveMultiply(q23_2.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q23val == '3' && !isFiveMultiply(q23_3.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
});
...
$(".24btn").click(function (e) {
    ...
    // 判斷小數位數
    // q24_1.val(fix(q24_1.val(),1));
    // q24_2.val(fix(q24_2.val(),1));
    // q24_3.val(fix(q24_3.val(),1));
    ...
    // else if (q24val == '1' && !isFiveMultiply(q24_1.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q24val == '2' && !isFiveMultiply(q24_2.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q24val == '3' && !isFiveMultiply(q24_3.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }

    var q24a = _this.find("input[name=q24a]:checked").val();
    var q24b = _this.find("input[name=q24b]:checked").val();
    if (!q24a)
         e.stopImmediatePropagation();
...
$(".25btn").click(function (e) {
    ...
    // 判斷小數位數
    // q25_1.val(fix(q25_1.val(),1));
    // q25_2.val(fix(q25_2.val(),1));
    // q25_3.val(fix(q25_3.val(),1));
    ...
    // else if (q25val == '1' && !isFiveMultiply(q25_1.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q25val == '2' && !isFiveMultiply(q25_2.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q25val == '3' && !isFiveMultiply(q25_3.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
...
$(".26btn").click(function (e) {
    ...
    var q26_1_2 = _this.find("input[name=q26_1_2]"); 

    var q26_2_1 = _this.find("input[name=q26_2_1]"); 
    var q26_2_2 = _this.find("input[name=q26_2_2]"); 

    var q26_3_1 = _this.find("input[name=q26_3_1]"); 
    var q26_3_2 = _this.find("input[name=q26_3_2]");



    // 判斷小數位數
    // q26_1_1.val(fix(q26_1_1.val(),1));
    // q26_1_2.val(fix(q26_1_2.val(),1));

    // q26_2_1.val(fix(q26_2_1.val(),1));
    // q26_2_2.val(fix(q26_2_2.val(),1));
    
    // q26_3_1.val(fix(q26_3_1.val(),1));
    // q26_3_2.val(fix(q26_3_2.val(),1));
    ...
    else if (q26val == '1' &&  q26_1_1.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    // else if (q26val == '1' && !isFiveMultiply(q26_1_1.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    
    if (q26val == '1' && q26_1_2.val() == ''){
        e.stopImmediatePropagation();
        alert('數值不能為空值');
    }
    else if (q26val == '1' && q26_1_2.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    // else if (q26val == '1' && !isFiveMultiply(q26_1_2.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }

    if(q26val == '1' && q26_1_1.val() <= 0 && q26_1_2.val() <= 0){
        e.stopImmediatePropagation();
        alert('兩個項目不能都為0');
    }
    ...
    else if (q26val == '2' && q26_2_1.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    // else if (q26val == '2' && !isFiveMultiply(q26_2_1.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    if (q26val == '2' && q26_2_2.val() == ''){
        e.stopImmediatePropagation();
        alert('數值不能為空值');
    }
    else if (q26val == '2' && q26_2_2.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    // else if (q26val == '2' && !isFiveMultiply(q26_2_2.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    if(q26val == '2' && q26_2_1.val() <= 0 && q26_2_2.val() <= 0){
        e.stopImmediatePropagation();
        alert('兩個項目不能都為0');
    }
    ...
    else if (q26val == '3' && q26_3_1.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    // else if (q26val == '3' && !isFiveMultiply(q26_3_1.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    if (q26val == '3' && q26_3_2.val() == ''){
        e.stopImmediatePropagation();
        alert('數值不能為空值');
    }
    else if (q26val == '3' && q26_3_2.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    // else if (q26val == '3' && !isFiveMultiply(q26_3_2.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    if(q26val == '3' && q26_3_1.val() <= 0 && q26_3_2.val() <= 0){
        e.stopImmediatePropagation();
        alert('兩個項目不能都為0');
    }
...
$(".27btn").click(function (e) {
    ...
    // 判斷小數位數
    // q27_1.val(fix(q27_1.val(),1));
    // q27_2.val(fix(q27_2.val(),1));
    // q27_3.val(fix(q27_3.val(),1));
    ...
    // else if (q27val == '1' && !isFiveMultiply(q27_1.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q27val == '2' && !isFiveMultiply(q27_2.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q27val == '3' && !isFiveMultiply(q27_3.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
...
$(".28btn").click(function (e) {
    ...
    // 判斷小數位數
    // q28_1.val(fix(q28_1.val(),1));
    // q28_2.val(fix(q28_2.val(),1));
    // q28_3.val(fix(q28_3.val(),1));
    ...
    // else if (q28val == '1' && !isFiveMultiply(q28_1.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q28val == '2' && !isFiveMultiply(q28_2.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
    ...
    // else if (q28val == '3' && !isFiveMultiply(q28_3.val())){
    //     e.stopImmediatePropagation();
    //     alert('最多增加0.5');
    // }
...
$(".29btn").click(function (e) {
    ...
    for (let i = 0; i < q29.size(); i++) {
        ...
        // if(q29a.val() == '5' && !isFiveMultiply(q29a_5.val())){
        ...
        let q29d = _this.find('.jump29a' + i).find(".q29d_s");     
        let hasVal = 0;
        var q29b_radio = $("input[name=q29b_radio]:checked");
        var q29d_radio = $("input[name=q29d_radio]:checked");
        ...
        q29b.each(function (index, item) {          
            ...
            if ($(item).val() < 0)
                hasVal = 2
            if (q29b_radio && $(item).val() == '0')
                hasVal = 5
                
            //     判斷小數位數
            // $(q29b_radio && item).val(fix($(item).val(),1))
                
        });


        q29d.each(function (index, item) {          
            if ($(item).val() > 0)
                hasVal = 3
            if ($(item).val() < 0)
                hasVal = 4
            if (q29d_radio && $(item).val() == '0')
                hasVal = 6

            //     判斷小數位數
            // $(q29d_radio && item).val(fix($(item).val(),1))
        });
    ...
    // if($("input[name='q29']:checked").size() == 1){
    //     var q29b_radio_checked = $('input[name=q29b_radio]:checked');
    //     var q29bs = q29b_radio_checked.next();
        // alert(q29bs.val())
        // if(!isFiveMultiply(q29bs.val())){
        //     e.stopImmediatePropagation();
        //     alert('"最多增加0.5"');
        // }
        // if(q29b_radio_checked && q29bs.val()==""){
        //     e.stopImmediatePropagation();
        //     alert('沒完成填答1');
        // }
    // }
    // if($("input[name='q29']:checked").size() == 2){
    //     var q29d_radio_checked = $('input[name=q29d_radio]:checked');
    //     var q29ds = q29d_radio_checked.next();
...
$(".30btn").click(function (e) {
    ...
    else if (q30val == '1' && q30_1.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    if(!(/^(\+|-)?\d+$/.test( q30_1.val() )) && q30_1.val()>0){
        
            e.stopImmediatePropagation();
            alert('數值不能有小數位數');
    }
    else if (q30val == '1' && q30_1.val() > 7){
        e.stopImmediatePropagation();
        alert('數值不能超過7');
    }
    ...
    else if (q30val == '2' && q30_2.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q30val == '2' && q30_2.val() > 6){
        e.stopImmediatePropagation();
        alert('天數不能超過6');
    }
    if(!(/^(\+|-)?\d+$/.test( q30_2.val() )) && q30_2.val()>0){
    ...
    else if (q30val == '3' && q30_3.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q30val == '3' && q30_3.val() > 4){
        e.stopImmediatePropagation();
        alert('天數不能超過4');
    }
    if(!(/^(\+|-)?\d+$/.test( q30_3.val() )) && q30_3.val()>0){
    ...
    else if (q30val == '4' && q30_4.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q30val == '4' && q30_4.val() > 2){
        e.stopImmediatePropagation();
        alert('天數不能超過2');
    }
    if(!(/^(\+|-)?\d+$/.test( q30_4.val() )) && q30_4.val()>0){
    ...
    else if (q30val == '5' && q30_5.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q30val == '5' && q30_5.val() > 3){
        e.stopImmediatePropagation();
        alert('天數不能超過3');
    }
    if(!(/^(\+|-)?\d+$/.test( q30_5.val() )) && q30_5.val()>0){
...
$(".31btn").click(function (e) {
    ...
    else if (q31val == '1' && q31_1.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q31val == '1' && q31_1.val() > 7){
        e.stopImmediatePropagation();
        alert('天數不能超過7');
    }
    if(!(/^(\+|-)?\d+$/.test( q31_1.val() )) && q31_1.val() > 0){
    ...
    else if (q31val == '2' && q31_2.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q31val == '2' && q31_2.val() > 6){
        e.stopImmediatePropagation();
        alert('天數不能超過6');
    }
    if(!(/^(\+|-)?\d+$/.test( q31_2.val() )) && q31_2.val() > 0){
    ...
    else if (q31val == '3' && q31_3.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q31val == '3' && q31_3.val() > 4){
        e.stopImmediatePropagation();
        alert('天數不能超過4');
    }
    if(!(/^(\+|-)?\d+$/.test( q31_3.val() )) && q31_3.val() > 0){
    ...
    else if (q31val == '4' && q31_4.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q31val == '4' && q31_4.val() > 2){
        e.stopImmediatePropagation();
        alert('天數不能超過2');
    }
    if(!(/^(\+|-)?\d+$/.test( q31_4.val() )) && q31_4.val() > 0){
    ...
    else if (q31val == '5' && q31_5.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q31val == '5' && q31_5.val() > 3){
        e.stopImmediatePropagation();
        alert('天數不能超過3');
    }
    if(!(/^(\+|-)?\d+$/.test( q31_5.val() )) && q31_5.val() > 0){
...
$(".32btn").click(function (e) {
    ...
    else if (q32val == '1' && q32_1.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q32val == '1' && q32_1.val() > 7){
        e.stopImmediatePropagation();
        alert('天數不能超過7');
    }
    if(!(/^(\+|-)?\d+$/.test( q32_1.val() )) && q32_1.val() > 0){
    ...
    else if (q32val == '2' && q32_2.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q32val == '2' && q32_2.val() > 6){
        e.stopImmediatePropagation();
        alert('天數不能超過6');
    }
    if(!(/^(\+|-)?\d+$/.test( q32_2.val() )) && q32_2.val() > 0){
    ...
    else if (q32val == '3' && q32_3.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q32val == '3' && q32_3.val() > 4){
        e.stopImmediatePropagation();
        alert('天數不能超過4');
    }
    if(!(/^(\+|-)?\d+$/.test( q32_3.val() )) && q32_3.val() > 0){
    ...
    else if (q32val == '4' && q32_4.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q32val == '4' && q32_4.val() > 2){
        e.stopImmediatePropagation();
        alert('天數不能超過2');
    }
    if(!(/^(\+|-)?\d+$/.test( q32_4.val() )) && q32_4.val() > 0){
    ...
    else if (q32val == '5' && q32_5.val() < 0){
        e.stopImmediatePropagation();
        alert('數值不能為負值');
    }
    else if (q32val == '5' && q32_5.val() > 3){
        e.stopImmediatePropagation();
        alert('天數不能超過3');
    }
    if(!(/^(\+|-)?\d+$/.test( q32_5.val() )) && q32_5.val() > 0){
...
$(".33btn").click(function (e) {
    ...
    // 判斷小數位數
    // q33_1.val(fix(q33_1.val(),1));
    // q33_2.val(fix(q33_2.val(),1));
    // q33_3.val(fix(q33_3.val(),1));
...
//     if(!(/^(\+|-)?\d+$/.test( q33_1.val() )) && q33_1.val() > 0){
...
//     if(!(/^(\+|-)?\d+$/.test( q33_2.val() )) && q33_2.val() > 0){
...
//     if(!(/^(\+|-)?\d+$/.test( q33_3.val() )) && q33_3.val() > 0){
...
$(".34btn").click(function (e) {
    ...
    // 判斷小數位數
    // q34_1.val(fix(q34_1.val(),1));
    // q34_2.val(fix(q34_2.val(),1));
    // q34_3.val(fix(q34_3.val(),1));
...
//     if(!(/^(\+|-)?\d+$/.test( q34_1.val() )) && q34_1.val() > 0){
...
//     if(!(/^(\+|-)?\d+$/.test( q34_2.val() )) && q34_2.val() > 0){
...
//     if(!(/^(\+|-)?\d+$/.test( q34_3.val() )) && q34_3.val() > 0){
...
$(".35btn").click(function (e) {
    ...
    var tr35_radio = $("input[name = q35_radio]:checked"); 
 
   
    if (tr35_radio.val()=='none')
    return true;
...
$(".36btn").click(function (e) {
    ...
    var tr36_radio = $("input[name = q36_radio]:checked");      
    
 
   
    if (tr36_radio.val()=='q36_2_00')
    return true;
...
// 35題最多勾選3種
$('input[name = q35_radio]').click(function() {

var tr35_radio = $("input[name = q35_radio]:checked");
var q35 = $('input[name = q35]');




if(tr35_radio.val() == "yes"){
    // q35.attr('disabled', false)
    $("input[name=q35]").attr('disabled', false);
    // $('.q35_tbody').css('display',"block")
} 
if(tr35_radio.val() == "none"){
    q35.attr('disabled', true)
    // $('.q35_tbody').css('display',"none")
    $(q35).each(function(){
    ...
    $('input[name=q35]').click(function() {//checkbox的input標籤點選事件
    $("input[name='q35']").attr('disabled', true);//設定name為q35的input標籤的屬性為true,表示不可選
    if ($("input[name='q35']:checked").length >= 3) {//選中個數大於3
    $("input[name='q35']:checked").attr('disabled', false);
    }  
    // else if($("input[name='q35']:checked").val()=='none'){
    //     $("input[name='q35']").attr('disabled', true);
    //     $("input[name='q35']:checked").attr('disabled', false);

    // }
 
    else if($("input[name='q35']:checked").length >= 1){
        $("input[name='q35']").attr('disabled', false);
        // $('#tr35_1').attr('disabled', true);
    }
    else  {
        $("input[name='q35']").attr('disabled', false);
        // $('#tr35_1').attr('disabled', false);
    }
    });
...
$('input[name = q36_radio]').click(function() {

    var tr36_radio = $("input[name = q36_radio]:checked");
    var q36 = $('input[name = q36]');
    
    
    if(tr36_radio.val() == "yes"){
        // q35.attr('disabled', false)
        $("input[name=q36]").attr('disabled', false);
        // $('.q35_tbody').css('display',"block")
    } 
    if(tr36_radio.val() == "q36_2_00"){
        q36.attr('disabled', true)
        // $('.q35_tbody').css('display',"none")
        $(q36).each(function(){
            $(this).prop("checked",false);
    });
    ...
    $('input[name=q36]').click(function() {//checkbox的input標籤點選事件
        $("input[name='q36']").attr('disabled', true);//設定name為q36的input標籤的屬性為true,表示不可選
        if ($("input[name='q36']:checked").length >= 3) {//選中個數大於3
        $("input[name='q36']:checked").attr('disabled', false);
        }  
        // else if($("input[name='q36']:checked").val()=='q36_2_00'){
        //     $("input[name='q36']").attr('disabled', true);
        //     $("input[name='q36']:checked").attr('disabled', false);

        // }
        else if($("input[name='q36']:checked").length >= 1){
            $("input[name='q36']").attr('disabled', false);
            // $('#tr36_0').attr('disabled', true);
        }
        else {
            $("input[name='q36']").attr('disabled', false);
            // $('#tr36_0').attr('disabled', false);
        }
        });
    ...
    $("input[name='q29']").click(function () {
        ...
        var wine =
            [
                ...
                { wineName: '清酒', wineSize: [10, 0, 1, 7, 8, 13] },
            ...
            // let size = [
            //     {sizeName:'小杯',htmlNameB:'q29b_1',htmlNameD:'q29d_1',photo_link:'img/0.png'},
            //     {sizeName:'小水杯',htmlNameB:'q29b_2',htmlNameD:'q29d_2',photo_link:'img/1.png'},
            //     {sizeName:'啤酒杯',htmlNameB:'q29b_3',htmlNameD:'q29d_3',photo_link:'img/2.png'},
            //     {sizeName:'小鋁罐',htmlNameB:'q29b_4',htmlNameD:'q29d_4',photo_link:'img/3.png'},
            //     {sizeName:'大鋁罐',htmlNameB:'q29b_5',htmlNameD:'q29d_5',photo_link:'img/4.png'},
            //     {sizeName:'小玻璃瓶',htmlNameB:'q29b_6',htmlNameD:'q29d_6',photo_link:'img/5.png'},
            //     {sizeName:'大玻璃瓶',htmlNameB:'q29b_7',htmlNameD:'q29d_7',photo_link:'img/6.png'},
            //     {sizeName:'杯',htmlNameB:'q29b_8',htmlNameD:'q29d_8',photo_link:'img/7.png'},
            //     {sizeName:'杯紅酒杯',htmlNameB:'q29b_9',htmlNameD:'q29d_9',photo_link:'img/8.png'},
            //     {sizeName:'罐維士比杯',htmlNameB:'q29b_10',htmlNameD:'q29d_10',photo_link:'img/9.png'},
            //     {sizeName:'杯裝清酒',htmlNameB:'q29b_11',htmlNameD:'q29d_11',photo_link:'img/10.png'},
            //     {sizeName:'罐鹿茸酒',htmlNameB:'q29b_12',htmlNameD:'q29d_12',photo_link:'img/12.png'},
            //     {sizeName:'罐韓國燒酒',htmlNameB:'q29b_13',htmlNameD:'q29d_13',photo_link:'img/11.png'},
            //     {sizeName:'毫升',htmlNameB:'q29b_14',htmlNameD:'q29d_14'}];



            let size = [
                // {sizeName:'小杯',htmlNameB:'q29b_1',htmlNameD:'q29d_1',photo_link:'img/1.png'},
                {sizeName:'小杯',htmlNameB:'q29b_1',htmlNameD:'q29d_1',photo_link:'/img/no29/0.jpg'},
                {sizeName:'小水杯',htmlNameB:'q29b_2',htmlNameD:'q29d_2',photo_link:'/img/no29/1.jpg'},
                {sizeName:'啤酒杯',htmlNameB:'q29b_3',htmlNameD:'q29d_3',photo_link:'/img/no29/2.jpg'},
                {sizeName:'小鋁罐',htmlNameB:'q29b_4',htmlNameD:'q29d_4',photo_link:'/img/no29/3.jpg'},
                {sizeName:'大鋁罐',htmlNameB:'q29b_5',htmlNameD:'q29d_5',photo_link:'/img/no29/4.jpg'},
                {sizeName:'小玻璃瓶',htmlNameB:'q29b_6',htmlNameD:'q29d_6',photo_link:'/img/no29/5.jpg'},
                {sizeName:'大玻璃瓶',htmlNameB:'q29b_7',htmlNameD:'q29d_7',photo_link:'/img/no29/6.jpg'},
                {sizeName:'份烈酒',htmlNameB:'q29b_8',htmlNameD:'q29d_8',photo_link:'/img/no29/7.jpg'},
                {sizeName:'杯紅酒杯',htmlNameB:'q29b_9',htmlNameD:'q29d_9',photo_link:'/img/no29/8.jpg'},
                {sizeName:'罐維士比杯',htmlNameB:'q29b_10',htmlNameD:'q29d_10',photo_link:'/img/no29/9.jpg'},
                {sizeName:'杯裝清酒',htmlNameB:'q29b_11',htmlNameD:'q29d_11',photo_link:'/img/no29/10.jpg'},
                {sizeName:'罐鹿茸酒',htmlNameB:'q29b_12',htmlNameD:'q29d_12',photo_link:'/img/no29/11.jpg'},
                {sizeName:'罐韓國燒酒',htmlNameB:'q29b_13',htmlNameD:'q29d_13',photo_link:'/img/no29/12.jpg'},
                {sizeName:'毫升',htmlNameB:'q29b_14',htmlNameD:'q29d_14'}];
        ...
        {          
            ...
            if (i == 0)
                wine[index].wineSize.forEach((item, index) => _html += `<label class="label_29b"><input type="radio" name="q29b_radio" value="${index + 1}">(${index + 1}) <input type="number" class="q29b_s" disabled="true" name="${size[item].htmlNameB}" min="0" step="0.5" />${size[item].sizeName} <img class="img_29" src="${size[item].photo_link}" alt=""></label><br>`);
            if (i == 1)
                wine[index].wineSize.forEach((item, index) => _html += `<label class="label_29b"><input type="radio" name="q29d_radio" value="${index + 1}">(${index + 1}) <input type="number" class="q29d_s" disabled="true" name="${size[item].htmlNameD}" min="0" step="0.5"/>${size[item].sizeName} <img class="img_29" src="${size[item].photo_link}" alt=""></label><br>`);
...
// radio檢查
    ...
    $("input[name = q24a]").click(function(e){
        var q24a =$("input[name = q24a]:checked").val()
        var q24b = $('.q24b');
        if(q24a == '5'){     
        q24b.attr("disabled",true);
        }
        else{
        q24b.attr("disabled",false);
        }
    ...
    $(".q15a_input").click(function (e) {
        ...
        if(q10_6_checked.val()=='F12'){
            q10_6_checked.next().attr('disabled',false);
        }
        else if(q10_6_checked.val()!=='F12'){
            q10_6_radio.next().attr('disabled',true)
            q20_1_reset.val('');
        }
    ...
    $(".q18a_input").click(function (e) {
        ...
        q10_6_radio.parent().next().attr('disabled',true)
        if(q10_6_checked.val()=='G10'){
            q10_6_checked.next().attr('disabled',false);
        }
        else if(q10_6_checked.val()!=='G10'){
            q10_6_radio.next().attr('disabled',true)
            q20_1_reset.val('');
        }
...
$(function(){
    $('.next').click(function(){ 
        $('html,body').animate({scrollTop:150}, 333);
    });
